...
import { Menu, X, Users, TrendingUp, Target, Award, Building, BookOpen, LogIn, LogOut, TestTube } from 'lucide-react';
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            {user && (
              <Link
                ...
                className="flex items-center space-x-2 px-3 py-2 rounded-lg text-sm font-medium text-foreground/70 hover:text-foreground hover:bg-muted/50 transition-smooth group"
              >
                <TestTube className="w-4 h-4 group-hover:text-primary transition-smooth" />
          ...
          <div className="space-y-2 pt-4 border-t border-border">
            ...
            {user && (
              <Link
                ...
                className="flex items-center space-x-3 px-4 py-3 rounded-lg text-foreground/70 hover:text-foreground hover:bg-muted/50 transition-smooth group"
              >
                <TestTube className="w-5 h-5 group-hover:text-primary transition-smooth" />
                <span className="font-medium">Test Subscription</span>
              </Link>
            )}
