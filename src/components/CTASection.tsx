...
const CTASection = () => {
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary to-[#A8482A]" />
      <div className="absolute inset-0 pattern-geometric opacity-5" />

      {/* Floating elements */}
      <div className="absolute top-10 left-10 w-32 h-32 bg-white/15 rounded-full blur-2xl floating" />
      <div className="absolute bottom-10 right-10 w-24 h-24 bg-white/15 rounded-full blur-2xl floating" style={{ animationDelay: '-2s' }} />
      <div className="absolute top-1/2 left-1/3 w-16 h-16 bg-white/15 rounded-full blur-xl floating" style={{ animationDelay: '-4s' }} />
