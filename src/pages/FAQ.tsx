    ...
    <div className="min-h-screen warm-page">
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs />
          {/* The page had no <h1> at all — breaks heading hierarchy for screen
              readers and weakens the page for search. FAQSection starts at h2,
              so this provides the document's single top-level heading. */}
