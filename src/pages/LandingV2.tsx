...
const LandingV2 = () => {
  ...
  useEffect(() => {
    ...
    const colors = ['#124C3B', '#124C3B', '#C9962E', '#D9885E', '#6FA37C'];
    const N = 16;
  ...
  const tabBtn = (active: boolean): React.CSSProperties => ({
    ...
    background: active ? '#124C3B' : '#FFFDF9',
    color: active ? '#F5F0E8' : '#6B5645',
    ...
    <>
      ...
      <div className="irv2-root" ref={rootRef}>
        ...
        >
          <div style={{ maxWidth: 1180, margin: '0 auto', padding: '16px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <a href="#top" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
              <BrandMark size={32} />
              <span style={{ ...FONT_HEAD, fontWeight: 600, fontSize: 19, color: '#111111', letterSpacing: '-.01em' }}>Indigenous Rising</span>
            </a>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
              ...
              <LinkTo to="/signup" className="irv2-hov-cta" style={{ background: '#124C3B', color: '#F5F0E8', textDecoration: 'none', fontSize: 14, fontWeight: 600, padding: '11px 20px', borderRadius: 10, boxShadow: '0 2px 10px rgba(18,76,59,.28)' }}><span className="ir-cta-long">Start free account</span><span className="ir-cta-short">Get Started</span></LinkTo>
              <button onClick={() => setMenuOpen((v) => !v)} aria-label="Menu" className="ir-burger" style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#111111', padding: 4 }}>
                <Icon icon="solar:hamburger-menu-linear" size={26} />
              </button>
            </div>
          </div>
          {menuOpen && (
            <div style={{ borderTop: '1px solid rgba(74,56,38,.08)', padding: '14px 24px 20px', display: 'flex', flexDirection: 'column', gap: 6, background: '#F5F0E8' }}>
        ...
        <section id="top" style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'absolute', inset: 0, zIndex: 1, background: 'radial-gradient(120% 80% at 50% 0%, rgba(250,246,239,.2) 0%, rgba(250,246,239,.7) 55%, #F5F0E8 100%)', pointerEvents: 'none' }} />
          <div style={{ position: 'relative', zIndex: 2, maxWidth: 1180, margin: '0 auto', padding: 'clamp(52px,9vw,88px) 24px 0', textAlign: 'center' }}>
            <div data-reveal style={{ display: 'inline-flex', alignItems: 'center', gap: 9, background: 'rgba(62,107,79,.1)', border: '1px solid rgba(62,107,79,.22)', color: '#124C3B', fontSize: 13, fontWeight: 600, padding: '7px 15px', borderRadius: 100, marginBottom: 30 }}>
              <span style={{ width: 7, height: 7, borderRadius: '50%', background: '#124C3B' }} />
              Built around Indigenous data sovereignty
            </div>
            <h1 data-reveal style={{ ...FONT_HEAD, fontWeight: 500, fontSize: 'clamp(34px,5vw,64px)', lineHeight: 1.08, letterSpacing: '-.025em', color: '#111111', maxWidth: 860, margin: '0 auto' }}>
            ...
            <div data-reveal style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center', alignItems: 'center', marginTop: 38 }}>
              <LinkTo to="/signup" className="irv2-hov-cta-lift" style={{ background: '#124C3B', color: '#F5F0E8', textDecoration: 'none', fontSize: 16, fontWeight: 600, padding: '16px 30px', borderRadius: 12, boxShadow: '0 6px 20px rgba(18,76,59,.3)', display: 'inline-flex', alignItems: 'center', gap: 9 }}>
                Start free account
                <Icon icon="solar:arrow-right-linear" size={19} />
              </LinkTo>
              <a href="#platform" className="irv2-hov-link" style={{ color: '#111111', textDecoration: 'none', fontSize: 16, fontWeight: 600, padding: '16px 14px', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
                See the platform
                <Icon icon="solar:play-circle-linear" size={19} />
              </a>
            </div>
            <p data-reveal style={{ marginTop: 20, fontSize: 13.5, color: '#5C554B', display: 'flex', gap: 18, justifyContent: 'center', flexWrap: 'wrap' }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}><Icon icon="solar:check-circle-bold" size={15} style={{ color: '#124C3B' }} /> Free to start</span>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}><Icon icon="solar:map-point-bold" size={15} style={{ color: '#124C3B' }} /> Your data stays in Canada</span>
        ...
        <section style={{ maxWidth: 1180, margin: '0 auto', padding: '96px 24px' }}>
          <div data-reveal style={{ maxWidth: 680 }}>
            <span style={{ fontSize: 13, fontWeight: 600, letterSpacing: '.14em', textTransform: 'uppercase', color: '#124C3B' }}>Who it helps</span>
            <h2 style={{ ...FONT_HEAD, fontWeight: 500, fontSize: 'clamp(30px,4vw,48px)', lineHeight: 1.08, letterSpacing: '-.02em', color: '#111111', margin: '14px 0 0' }}>Built for the people doing the work.</h2>
          ...
          <div className="ir-3col" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 22, marginTop: 48 }}>
            {[
              { icon: 'solar:rocket-2-linear', accent: '#124C3B', soft: 'rgba(18,76,59,.12)', title: 'Entrepreneurs & small businesses', desc: 'Find the right funding, write a fundable business plan, and build the skills to grow — without paying for a dozen consultants.' },
              { icon: 'solar:users-group-rounded-linear', accent: '#124C3B', soft: 'rgba(62,107,79,.12)', title: 'First Nations, Métis & Inuit communities', desc: 'Support economic development across your membership with tools your own team controls — and data that stays yours.' },
              { icon: 'solar:hand-heart-linear', accent: '#D79A27', soft: 'rgba(201,150,46,.16)', title: 'Funders & support organizations', desc: 'Help more applicants reach "yes" with clearer plans and better-matched funding — and spend less time on back-and-forth.' },
            ].map((c) => (
              <div key={c.title} data-reveal style={{ background: '#FFFDF9', border: '1px solid rgba(74,56,38,.1)', borderRadius: 18, padding: 30 }}>
                ...
                <h3 style={{ ...FONT_HEAD, fontWeight: 600, fontSize: 22, color: '#111111', margin: '0 0 10px' }}>{c.title}</h3>
        ...
        <section id="how" style={{ background: '#F4ECE0', borderTop: '1px solid rgba(74,56,38,.07)', borderBottom: '1px solid rgba(74,56,38,.07)' }}>
          <div style={{ maxWidth: 1180, margin: '0 auto', padding: '96px 24px' }}>
            <div data-reveal style={{ textAlign: 'center', maxWidth: 680, margin: '0 auto' }}>
              <span style={{ fontSize: 13, fontWeight: 600, letterSpacing: '.14em', textTransform: 'uppercase', color: '#124C3B' }}>How it works</span>
              <h2 style={{ ...FONT_HEAD, fontWeight: 500, fontSize: 'clamp(30px,4vw,48px)', lineHeight: 1.08, letterSpacing: '-.02em', color: '#111111', margin: '14px 0 0' }}>From idea to funded. In days, not months.</h2>
            ...
            <div className="ir-4col" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 26, marginTop: 58 }}>
              {STEPS.map((s) => (
                <div key={s.num} data-reveal style={{ position: 'relative' }}>
                  <div style={{ ...FONT_HEAD, fontSize: 46, lineHeight: 1, color: '#124C3B', marginBottom: 14 }}>{s.num}</div>
                  <h3 style={{ ...FONT_HEAD, fontWeight: 600, fontSize: 20, color: '#111111', margin: '0 0 9px' }}>{s.title}</h3>
        ...
        <section id="platform" style={{ maxWidth: 1180, margin: '0 auto', padding: '100px 24px' }}>
          <div data-reveal style={{ textAlign: 'center', maxWidth: 680, margin: '0 auto' }}>
            <span style={{ fontSize: 13, fontWeight: 600, letterSpacing: '.14em', textTransform: 'uppercase', color: '#124C3B' }}>The platform</span>
            <h2 style={{ ...FONT_HEAD, fontWeight: 500, fontSize: 'clamp(30px,4vw,48px)', lineHeight: 1.08, letterSpacing: '-.02em', color: '#111111', margin: '14px 0 0' }}>Four tools. One platform you control.</h2>
            ...
            {MODULES.map((m) => (
              <div key={m.title} data-reveal className="irv2-hov-card" style={{ background: '#FFFDF9', border: '1px solid rgba(74,56,38,.1)', borderRadius: 20, padding: 32, display: 'flex', flexDirection: 'column' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 14, marginBottom: 18 }}>
                  ...
                  <span style={{ display: 'inline-flex', alignItems: 'center', gap: 7, fontSize: 12.5, fontWeight: 600, color: '#124C3B', background: 'rgba(62,107,79,.1)', border: '1px solid rgba(62,107,79,.2)', padding: '6px 12px', borderRadius: 100, whiteSpace: 'nowrap' }}>
                    <span style={{ width: 7, height: 7, borderRadius: '50%', background: '#124C3B' }} /> Live today
                  </span>
                </div>
                <h3 style={{ ...FONT_HEAD, fontWeight: 600, fontSize: 23, color: '#111111', margin: '0 0 10px' }}>{m.title}</h3>
                <p style={{ fontSize: 15.5, lineHeight: 1.66, color: '#6B5645', margin: '0 0 18px' }}>{m.desc}</p>
                <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', gap: 9, fontSize: 13.5, color: '#5C554B', borderTop: '1px dashed rgba(74,56,38,.16)', paddingTop: 16 }}>
                  <Icon icon="solar:map-arrow-up-linear" size={16} style={{ color: '#D79A27' }} />
        ...
        <section style={{ maxWidth: 1180, margin: '0 auto', padding: '100px 24px' }}>
          <div data-reveal style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto' }}>
            <span style={{ fontSize: 13, fontWeight: 600, letterSpacing: '.14em', textTransform: 'uppercase', color: '#124C3B' }}>A closer look</span>
            <h2 style={{ ...FONT_HEAD, fontWeight: 500, fontSize: 'clamp(30px,4vw,48px)', lineHeight: 1.08, letterSpacing: '-.02em', color: '#111111', margin: '14px 0 0' }}>See it in action.</h2>
          </div>
          ...
          <div data-reveal style={{ marginTop: 30, background: '#FFFDF9', border: '1px solid rgba(74,56,38,.12)', borderRadius: 20, boxShadow: '0 24px 60px -30px rgba(44,30,18,.3)', overflow: 'hidden', minHeight: 420 }}>
              ...
              <div style={{ padding: 32 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12, marginBottom: 22 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    ...
                    <span style={{ fontSize: 13, color: '#F5F0E8', background: '#124C3B', padding: '8px 14px', borderRadius: 10, fontWeight: 600 }}>All · 12</span>
                  </div>
                </div>
                <div className="ir-2col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                  {[
                    { fit: '94% fit', fitColor: '#0F3F31', fitBg: 'rgba(18,76,59,.12)', right: '21 days left', rightColor: '#124C3B', title: 'Aboriginal Business Financing Program', desc: 'Non-repayable contribution toward business start-up and expansion costs.', amount: 'up to $99,999' },
                    { fit: '88% fit', fitColor: '#6B4A05', fitBg: 'rgba(215,154,39,.18)', right: 'Rolling', rightColor: '#5C554B', title: 'Indigenous Growth Fund', desc: 'Flexible working-capital loans for established Indigenous businesses.', amount: 'flexible terms' },
                  ].map((c) => (
                    <div key={c.title} style={{ border: '1px solid rgba(74,56,38,.1)', borderRadius: 14, padding: 18 }}>
                      ...
                      <h4 style={{ fontSize: 16, fontWeight: 600, color: '#111111', margin: '13px 0 5px' }}>{c.title}</h4>
                      <p style={{ fontSize: 13.5, color: '#6B5645', margin: '0 0 14px', lineHeight: 1.55 }}>{c.desc}</p>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ ...FONT_HEAD, fontSize: 22, color: '#111111' }}>{c.amount}</span>
                        <span style={{ fontSize: 13, color: '#124C3B', fontWeight: 600 }}>View →</span>
                      </div>
                    </div>
                  ))}
                </div>
                <div style={{ marginTop: 14, display: 'flex', alignItems: 'center', gap: 10, background: '#F4ECE0', borderRadius: 12, padding: '14px 18px' }}>
                  <Icon icon="solar:bell-bing-linear" size={20} style={{ color: '#124C3B' }} />
            ...
            {tab === 'plan' && (
              <div className="ir-mock-grid" style={{ display: 'grid', gridTemplateColumns: '230px 1fr', minHeight: 420 }}>
                <div style={{ background: '#F4ECE0', borderRight: '1px solid rgba(74,56,38,.08)', padding: '24px 18px' }}>
                  <h4 style={{ fontSize: 13, textTransform: 'uppercase', letterSpacing: '.1em', color: '#5C554B', margin: '0 0 16px' }}>Your plan · 60%</h4>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '9px 11px', borderRadius: 9, fontSize: 14, color: '#111111', background: '#FFFDF9', fontWeight: 600 }}><Icon icon="solar:check-circle-bold" size={17} style={{ color: '#124C3B' }} /> Executive summary</div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '9px 11px', borderRadius: 9, fontSize: 14, color: '#111111', background: '#FFFDF9', fontWeight: 600 }}><Icon icon="solar:check-circle-bold" size={17} style={{ color: '#124C3B' }} /> Market & customers</div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '9px 11px', borderRadius: 9, fontSize: 14, color: '#124C3B', border: '1px solid rgba(18,76,59,.3)', fontWeight: 600 }}><Icon icon="solar:pen-2-linear" size={17} /> Financial plan</div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '9px 11px', borderRadius: 9, fontSize: 14, color: '#5C554B' }}><Icon icon="solar:lock-keyhole-minimalistic-linear" size={17} /> Operations</div>
                  </div>
                </div>
                <div style={{ padding: '30px 32px' }}>
                  <span style={{ fontSize: 12, fontWeight: 600, letterSpacing: '.1em', textTransform: 'uppercase', color: '#124C3B' }}>Financial plan</span>
                  <h3 style={{ ...FONT_HEAD, fontWeight: 600, fontSize: 24, color: '#111111', margin: '8px 0 16px' }}>Let's project your first year.</h3>
                  <div style={{ background: '#F7F1E8', border: '1px solid rgba(74,56,38,.1)', borderRadius: 14, padding: 20, marginBottom: 16 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                      <div style={{ width: 30, height: 30, borderRadius: 8, background: '#124C3B', color: '#F5F0E8', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Icon icon="solar:stars-minimalistic-linear" size={17} /></div>
                      <span style={{ fontSize: 13, fontWeight: 600, color: '#5C554B' }}>Assistant</span>
                    </div>
                  ...
                  <div style={{ display: 'flex', gap: 10 }}>
                    <span style={{ fontSize: 14, color: '#F5F0E8', background: '#124C3B', padding: '10px 16px', borderRadius: 10, fontWeight: 600 }}>Draft both scenarios</span>
            ...
            {tab === 'training' && (
              <div style={{ padding: 32 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12, marginBottom: 22 }}>
                  <div>
                    <h3 style={{ ...FONT_HEAD, fontWeight: 600, fontSize: 23, color: '#111111', margin: 0 }}>Training & Certification</h3>
                    <p style={{ fontSize: 14, color: '#5C554B', margin: '5px 0 0' }}>Short, practical lessons · learn at your pace</p>
                  </div>
                  <span style={{ fontSize: 13, color: '#124C3B', background: 'rgba(62,107,79,.1)', padding: '8px 14px', borderRadius: 10, fontWeight: 600 }}>3 in progress</span>
                </div>
                <div className="ir-3col" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 14 }}>
                  {[
                    { grad: 'linear-gradient(135deg,#124C3B,#E0926E)', icon: 'solar:wallet-money-linear', title: 'Financing basics', pct: 75, note: '6 of 8 lessons' },
                    { grad: 'linear-gradient(135deg,#124C3B,#6FA37C)', icon: 'solar:shop-linear', title: 'Marketing your business', pct: 40, note: '2 of 5 lessons' },
                    ...
                    <div key={c.title} style={{ border: '1px solid rgba(74,56,38,.1)', borderRadius: 14, overflow: 'hidden' }}>
                      <div style={{ height: 90, background: c.grad, display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Icon icon={c.icon} size={34} style={{ color: '#F5F0E8' }} /></div>
                      <div style={{ padding: 16 }}>
                        <h4 style={{ fontSize: 15, fontWeight: 600, color: '#111111', margin: '0 0 8px' }}>{c.title}</h4>
                        <div style={{ height: 6, background: '#EDE2D2', borderRadius: 100, overflow: 'hidden' }}><div style={{ width: `${c.pct}%`, height: '100%', background: '#124C3B' }} /></div>
                        <p style={{ fontSize: 12.5, color: '#5C554B', margin: '8px 0 0' }}>{c.note}</p>
                      </div>
                    </div>
                  ))}
                </div>
                <div style={{ marginTop: 14, display: 'flex', alignItems: 'center', gap: 10, background: '#F4ECE0', borderRadius: 12, padding: '14px 18px' }}>
                  <Icon icon="solar:map-arrow-up-linear" size={20} style={{ color: '#D79A27' }} />
            ...
            {tab === 'growth' && (
              <div style={{ padding: 32 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12, marginBottom: 24 }}>
                  <div>
                    <h3 style={{ ...FONT_HEAD, fontWeight: 600, fontSize: 23, color: '#111111', margin: 0 }}>Growth & Data Tools</h3>
                    <p style={{ fontSize: 14, color: '#5C554B', margin: '5px 0 0' }}>Last 6 months · data you own</p>
                  </div>
                ...
                <div className="ir-3col" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 14, marginBottom: 18 }}>
                  {[
                    { label: 'Revenue', value: '$31,400', delta: '▲ 18% vs prior', deltaColor: '#124C3B' },
                    { label: 'Customers', value: '142', delta: '▲ 9 this month', deltaColor: '#124C3B' },
                    { label: 'Goal progress', value: '72%', delta: 'to $45k target', deltaColor: '#D79A27' },
                  ].map((s) => (
                    <div key={s.label} style={{ background: '#F7F1E8', borderRadius: 14, padding: 18 }}>
                      <p style={{ fontSize: 13, color: '#5C554B', margin: '0 0 6px' }}>{s.label}</p>
                      <div style={{ ...FONT_HEAD, fontSize: 28, color: '#111111' }}>{s.value}</div>
                ...
                <div style={{ border: '1px solid rgba(74,56,38,.1)', borderRadius: 14, padding: 20 }}>
                  <div style={{ display: 'flex', alignItems: 'flex-end', gap: 14, height: 140 }}>
                    {[
                      ...
                      { h: '84%', bg: '#124C3B', m: 'May' },
                      { h: '100%', bg: '#124C3B', m: 'Jun' },
                    ].map((b) => (
                      <div key={b.m} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
                        ...
                        <span style={{ fontSize: 11, color: '#5C554B' }}>{b.m}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <section id="pricing" style={{ background: '#F4ECE0', borderTop: '1px solid rgba(74,56,38,.07)', borderBottom: '1px solid rgba(74,56,38,.07)' }}>
          <div style={{ maxWidth: 1180, margin: '0 auto', padding: '100px 24px' }}>
            <div data-reveal style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto' }}>
              <span style={{ fontSize: 13, fontWeight: 600, letterSpacing: '.14em', textTransform: 'uppercase', color: '#124C3B' }}>Pricing</span>
              <h2 style={{ ...FONT_HEAD, fontWeight: 500, fontSize: 'clamp(30px,4vw,48px)', lineHeight: 1.08, letterSpacing: '-.02em', color: '#111111', margin: '14px 0 0' }}>Honest pricing. Start free.</h2>
            ...
            <div className="ir-3col" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 20, marginTop: 50, alignItems: 'stretch' }}>
              {PLANS.map((p) => {
                ...
                const btnStyle = cta.variant === 'dark'
                  ? { ...btnBase, background: '#111111', color: '#F5F0E8' }
                  : cta.variant === 'terracotta'
                  ? { ...btnBase, background: '#124C3B', color: '#F5F0E8' }
                  : { ...btnBase, background: '#FFFDF9', color: '#111111', border: '1px solid rgba(74,56,38,.2)' };
                const btnClass = cta.variant === 'dark' ? 'irv2-hov-free-btn' : cta.variant === 'terracotta' ? 'irv2-hov-growth-btn' : 'irv2-hov-nations-btn';
                const checkColor = dark ? '#8FBF9C' : '#124C3B';
                const comingColor = dark ? '#D9B45A' : '#D79A27';
                ...
                return (
                  <div key={p.key} data-reveal style={{ background: dark ? '#241910' : '#FFFDF9', color: dark ? '#F3E9DB' : undefined, border: dark ? undefined : '1px solid rgba(74,56,38,.12)', borderRadius: 20, padding: 32, display: 'flex', flexDirection: 'column', position: 'relative', boxShadow: dark ? '0 24px 60px -28px rgba(44,30,18,.5)' : undefined }}>
                    {p.popular && (
                      <span style={{ position: 'absolute', top: 18, right: 18, fontSize: 11.5, fontWeight: 600, letterSpacing: '.08em', textTransform: 'uppercase', background: '#124C3B', color: '#F5F0E8', padding: '5px 11px', borderRadius: 100 }}>Most popular</span>
                    )}
                    <h3 style={{ ...FONT_HEAD, fontWeight: 600, fontSize: 22, color: dark ? '#FBF5EC' : '#111111', margin: 0 }}>{p.name}</h3>
                    <p style={{ fontSize: 14, color: dark ? '#C8B6A2' : '#8A7560', margin: '6px 0 18px' }}>{p.tagline}</p>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 22 }}>
                      <span style={{ ...FONT_HEAD, fontSize: p.period ? 46 : 38, color: dark ? '#FBF5EC' : '#111111' }}>{p.priceLabel}</span>
            ...
            <p data-reveal style={{ textAlign: 'center', fontSize: 13.5, color: '#5C554B', margin: '28px auto 0', maxWidth: 560, lineHeight: 1.6 }}>All plans are billed in CAD. Cancel anytime — your data stays exportable.</p>
          </div>
        </section>
        ...
        <section id="faq" style={{ maxWidth: 820, margin: '0 auto', padding: '100px 24px' }}>
          <div data-reveal style={{ textAlign: 'center', marginBottom: 44 }}>
            <span style={{ fontSize: 13, fontWeight: 600, letterSpacing: '.14em', textTransform: 'uppercase', color: '#124C3B' }}>Questions</span>
            <h2 style={{ ...FONT_HEAD, fontWeight: 500, fontSize: 'clamp(30px,4vw,46px)', lineHeight: 1.08, letterSpacing: '-.02em', color: '#111111', margin: '14px 0 0' }}>Straight answers.</h2>
          </div>
            ...
            {FAQS.map((f, i) => {
              ...
              return (
                <div key={f.q} style={{ background: '#FFFDF9', border: '1px solid rgba(74,56,38,.12)', borderRadius: 14, overflow: 'hidden' }}>
                  <button onClick={() => setFaqOpen(open ? -1 : i)} aria-expanded={open} aria-controls={`faq-panel-${i}`} id={`faq-trigger-${i}`} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, padding: '20px 24px', background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', ...FONT_HEAD, fontWeight: 600, fontSize: 18, color: '#111111' }}>
                    {f.q}
                    <Icon icon={open ? 'solar:minus-circle-linear' : 'solar:add-circle-linear'} size={22} style={{ color: '#124C3B', flexShrink: 0 }} aria-hidden="true" />
                  </button>
          ...
          <div data-reveal style={{ background: '#124C3B', borderRadius: 26, padding: 'clamp(40px,6vw,76px)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center', marginTop: 34 }}>
                <LinkTo to="/signup" className="irv2-hov-lift" style={{ background: '#FFF7F0', color: '#124C3B', textDecoration: 'none', fontSize: 16, fontWeight: 600, padding: '16px 32px', borderRadius: 12, display: 'inline-flex', alignItems: 'center', gap: 9, boxShadow: '0 8px 24px rgba(36,25,16,.2)' }}>
