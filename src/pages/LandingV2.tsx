            ...
            <div className="ir-sov-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'start' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {[
                  ...
                  { icon: 'solar:map-point-linear', iconBg: 'rgba(111,163,124,.2)', iconColor: '#8FBF9C', title: 'Stored in Canada', body: <>Your data is stored in Canada (AWS <span style={{ fontFamily: 'monospace', fontSize: 13, color: '#E0926E' }}>ca-central-1</span>), encrypted in transit and at rest.</> },
