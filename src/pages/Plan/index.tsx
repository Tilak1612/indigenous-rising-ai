    ...
    <main className="min-h-screen bg-neutral-900 text-white py-10 px-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <header>
          ...
          <p className="text-sm text-white/70 mt-1">Guided steps, templates, and AI copilots to help create your plan.</p>
        </header>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <aside className="space-y-4">
            <div className="bg-white/4 p-4 rounded-lg">
              ...
              <p className="text-sm text-white/70 mt-1">Choose a sector template to start faster.</p>
            </div>
