...
export const exportGrantAppendix = async (_planDraft: Record<string, string>) => {
  // Placeholder: integrate real grant appendix export
};

export const exportCommunitySummary = async (_planDraft: Record<string, string>) => {
  // Placeholder: integrate real community summary export
};
