...
const FAQS: Faq[] = [
  ...
  { q: "Is my business data stored in Canada?", a: "Your account, business plans, documents and files are stored on Canadian servers under Canadian jurisdiction, PIPEDA-aligned. Some processing happens with named providers outside Canada \u2014 email delivery, payments, analytics if you accept analytics cookies, and AI funding matching, which sends a limited profile summary to OpenAI only when you ask for matches. Your identity, community, name and contact details are never sent to the AI provider. The privacy policy lists them all." },
